...
filenames_switched = {#1: '2022-10-21_14-50-59_394647.h5',  # <- here mics in positions 1 and 2 (indices 0 and 1) are switched 
                      1: '2022-10-21_14-49-05_177449.h5',  # <- here mics in positions 1 and 3 (indices 0 and 2) are switched
                      2: '2022-10-21_14-47-35_017850.h5' # 1-3-2 Konf
                      }
...
saveMat = True
matName = './Mats/rect_10cmBasotect_fixed.mat'
