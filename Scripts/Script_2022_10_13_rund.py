...
calibpath = '../Tornado_TL_Messungen/metadata'
calibfile = 'calibdata_2022-10-13_12-20-56_708771.xml'
calibration = Calib(from_file=join(calibpath, calibfile))

soundfilepath = '../Tornado_TL_Messungen/td'
plotname = 'TL_Basotect_5cm_rund'

# filename of empty measurement with direct configuration:

filename_direct = '2022-10-13_14-41-24_820476.h5'
#channels of switched mic and filenames of measurements with switched configurations
filenames_switched = {1: '2022-10-13_14-42-42_870872.h5',  # <- here 2nd mic (index 1) was switched w/ ref (index 0)
                      2: '2022-10-13_14-45-29_301248.h5',
                      3: '2022-10-13_14-46-50_152366.h5',
                      4: '2022-10-13_14-48-26_200219.h5',
                      5: '2022-10-13_14-50-33_413277.h5'}
...
filenames_measurement = [#'2022-10-13_14-52-04_716870.h5' # Leermessung
                         '2022-10-13_15-01-00_253026.h5' # runde Basotect mit d = 5 cm
                         ]
...
for filename_measurement in filenames_measurement:
    ...
    for spacing in ['wide', 'narrow']:
        if spacing == 'narrow':
            tube = imp.Tube_Transmission(tube_shape='circ',
                                         tube_d=0.1,
                                         # l1 und l2 von mittlere Ring auch beeinflusst. Daher nicht symmetrisch nach 5 cm Dicke.
                                         l1=0.20,   # distance between beginning of specimen and mic 2
                                         l2=0.28,   # distance between beginning of specimen and mic 3
                                         s1=0.075,  # Distance between mic 1 and 2
                                         s2=0.075,  # Distance between mic 3 and 4
            ...
            tube = imp.Tube_Transmission(tube_shape='circ',
                                         ...
                                         l1=0.20,   # distance between beginning of specimen and mic 2
                                         l2=0.28,   # distance between beginning of specimen and mic 3
                                         s1=0.3,  # Distance between mic 1 and 2
                                         s2=0.3,  # Distance between mic 3 and 4
                                         d=0.05)   # length of test specimen (test tube section is 0.7m))
