...
filename_direct = '2022-10-21_15-16-48_608765.h5' #TODO: correct the files
# channels of switched mic and filenames of measurements with switched configurations
filenames_switched = {#1: '2022-10-21_15-21-40_911062.h5', #,  # <- here mics in positions 1 and 2 (indices 0 and 1) are switched
                      1: '2022-10-21_15-19-54_760486.h5',  # <- here mics in positions 1 and 3 (indices 0 and 2) are switched
                      2: '2022-10-21_15-18-15_476764.h5', # 1-3-2 Konf, 
                      }
...
filenames_measurement = [#'2022-10-21_15-23-10_482800.h5' # Leermessung
                         #'2022-10-21_15-27-05_457333.h5'  # 5 cm thick Basotect
                         '2022-10-21_15-32-31_707153.h5'   # 10 cm thick Basotect
                         ]
...
saveMat = False
matName = './Mats/rund_10cmBasotect_fixed.mat'
...
for filename_measurement in filenames_measurement:
    ...
    for spacing in ['wide', 'narrow']:
        if spacing == 'narrow':
            ...
            tube = imp.Tube_Impedance(tube_shape='circ',
                                      tube_d=0.1,
                                      s=0.075,
                                      x1=0.275)
            '''Or use a preset:'''
